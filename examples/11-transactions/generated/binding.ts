...
export interface Mutation {
    createTwoTransactionSuccess: <T = Array<User>>(args: { data: UserCreateInput }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T> ,
    createTwoTransactionFail: <T = Array<User>>(args: { data: UserCreateInput }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T> 
  }
